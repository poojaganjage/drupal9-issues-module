...
You might have contributors adding unnecessary empty lines at the end of their contribution. But your CSS takes care of the extra spacing below paragraphs so no need for extra <code><p></p></code> Also remove <script> tags even you are in Full HTML.
