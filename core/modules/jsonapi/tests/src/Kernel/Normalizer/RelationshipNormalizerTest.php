      ...
      'single cardinality' => [
        ...
        [
          'data' => [
            ...
            'id' => static::$userIds[0],
            'meta' => [
              'drupal_internal__' => static::$userUids[0],
            ],
          ],
        ],
      ],
        ...
        ['user1', 'user2'], 'field_users', [
          'data' => [
            ...
            [
              ...
              'id' => static::$userIds[1],
              'meta' => [
                'drupal_internal__' => static::$userUids[1],
              ],
            ],
          ],
        ],
        ...
        ['image1'], 'field_image', [
          'data' => [
            ...
            'meta' => [
              ...
              'width' => NULL,
              'height' => NULL,
              'drupal_internal__' => static::$imageUids[0],
            ],
          ],
        ],
      ],
